  ...
  >
    <div class="user-page">
      <b-form-group label-cols="4" label-cols-lg="3" label="Brand No." label-for="BrandNo">
        <b-form-input id="BrandNo" :value="userDisplay.BrandNo" disabled></b-form-input>
      </b-form-group>
      <b-form-group label-cols="4" label-cols-lg="3" label="Member No." label-for="MemberNo">
        <b-form-input id="MemberNo" :value="userDisplay.MemberNo" disabled></b-form-input>
      </b-form-group>
      <b-form-group label-cols="4" label-cols-lg="3" label="Member Name" label-for="MemberName">
        <b-form-input id="MemberName" :value="userDisplay.MemberName" disabled></b-form-input>
      </b-form-group>
      <b-form-group label-cols="4" label-cols-lg="3" label="Address" label-for="Address">
        <b-form-input id="Address" :value="userDisplay.Address" disabled></b-form-input>
      </b-form-group>
      <b-form-group label-cols="4" label-cols-lg="3" label="Email" label-for="Email">
        <b-form-input id="Email" :value="userDisplay.Email" disabled></b-form-input>
      </b-form-group>
      <b-form-group label-cols="4" label-cols-lg="3" label="Tel" label-for="Tel">
        <b-form-input id="Tel" :value="userDisplay.Tel" disabled></b-form-input>
      </b-form-group>
    </div>
...
export default {
  ...
  computed: {
    ...
    userDisplay() {
      ...
      let { BrandNo, MemberNo, MemberName, Address, Email, Tel } = { ...user };
